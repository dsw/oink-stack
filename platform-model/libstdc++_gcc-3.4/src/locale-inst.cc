#include <glibc-fs/prelude-cxx.h>
// Locale support -*- C++ -*-
...
//     // quarl 2006-06-14
//     //    change inline template instantiations to regular instantiations
//     //    because Elsa 2006-06-14 doesn't understand them; both are
//     //    essentially no-ops to Oink.
